	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$data['menus'][] = array(
				...
				'href'     => $this->url->link('customer/supplier', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);
			...
			$data['menus'][] = array(
				'id'       => 'menu-shipper',
				'icon'	   => 'fa-user',
				'name'	   => $this->language->get('text_shipper'),
				'href'     => $this->url->link('customer/shipper', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);
			...
			$data['menus'][] = array(
				...
				'href'     => $this->url->link('customer/buyer', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);
