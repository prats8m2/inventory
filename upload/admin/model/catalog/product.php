...
class ModelCatalogProduct extends Model {
	...
	public function deleteWhileAdd(){
		$query = $this->db->query("DELETE n1 FROM oc_product n1, oc_product n2 WHERE n1.product_id < n2.product_id AND n1.date_added = n2.date_added");
